...
out/savekey.bin:	src/savekey.asm out
	echo "\n###### Creating savekey.bin... ######"
	${DASM} src/savekey.asm -f3 -oout/savekey.bin -sout/savekey.symbol.txt -lout/savekey.annotated_source.txt

out/savekey.a78:	src/cartridge_header_savekey.asm out/savekey.bin ${7800SIGN} out
	echo "\n###### Signing savekey.bin... ######"
	${7800SIGN} -w out/savekey.bin
	echo "\n\n###### Creating savekey.a78... ######"
	${DASM} src/cartridge_header_savekey.asm -f3 -oout/savekey.a78
...
run:	${A7800}
	cd bin/a7800 && ./a7800 a7800 -cart ../../out/savekey.a78

debug:	${A7800}
	cd bin/a7800 && ./a7800 a7800 -cart ../../out/savekey.a78 -debug

devel:	${A7800}
	cd bin/a7800 && ./a7800 a7800dev -cart ../../out/savekey.a78
